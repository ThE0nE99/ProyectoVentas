...
<asp:Button ID="btnAgregarProveedor" runat="server" Text="AgregarProveedor" OnClick="btnAgregarProveedor_Click" CssClass="btn btn-primary" />
        ...
        <div>
            ...
            <asp:GridView ID="gridViewProveedores" runat="server" AutoGenerateColumns="false">
                <Columns>
                    <asp:BoundField DataField="TipoProveedor" HeaderText="Tipo de Proveedor" />
                    <asp:BoundField DataField="RazonSocialProveedor" HeaderText="Razón Social" />
                    <asp:BoundField DataField="DireccionProveedor" HeaderText="Dirección" />
                    <asp:BoundField DataField="CelularProveedor" HeaderText="Celular" />
                    <asp:BoundField DataField="CorreoProveedor" HeaderText="Correo" />
                </Columns>
            </asp:GridView>
