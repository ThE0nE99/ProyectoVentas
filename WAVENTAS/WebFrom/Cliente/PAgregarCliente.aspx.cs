...
public partial class WebFrom_Cliente_PAgregarCliente : System.Web.UI.Page
{
	...
	protected void btnBuscarCliente_Click(object sender, EventArgs e)
	{
		...
		if (int.Parse(txbCodigoCliente.Text) > 0)
		{
			...
			if (eVCliente != null)
			{
				lbObtenerCliente.Text = "  RazonSocial Cliente: " + eVCliente.RazonSocialCliente + " CI o NIT: " + eVCliente.CiONitCliente + "  TipoCliente: " + eVCliente.TipoCliente + "  DireccionCliente: " + eVCliente.DirecionCliente + "  CelularCliente: " + eVCliente.CelularCliente;
	...
	protected void btnBuscarClienteActualizar_Click(object sender, EventArgs e)
	{
		...
		//{
		//    EVCliente eVcliente = cCliente.Obtener_VCliente_O(int.Parse(txbCodigoClienteActualizar.Text));
		//    if (eVcliente != null)
		//    {
		//        EVCliente eVCliente = cCliente.Obtener_VCliente_O(int.Parse(txbCodigoClienteActualizar.Text));
		//        txbRazonSocialClienteActualizar.Text = eVCliente.RazonSocialCliente;
	...
	{
		List<EVCliente> lstEVArticulos = cCliente.Obtener_VClientes_O_Todo();
		gridViewClientes.DataSource = lstEVArticulos;
